    ...
    try{
        ...
        if(indicator === "vote" && req.cookies.voted){
            ...
            Article.find({tags:{$in:[...tagArr]} }, (err, data) => {
                ...
                res.cookie('voted',true,{expires:date3,sameSite:"none",secure:true, domain: "https://todayifeel.netlify.app"})
                res.send(sortedArr)
            }); 
        }
        if(indicator === "search"){
...
app.post("/user", async (req,res)=>{
    ...
    try{
        ...
        res.cookie('jwt',token,{maxAge:maxAge * 1000,sameSite:"none",secure:true, domain: "https://todayifeel.netlify.app"})
...
app.get("/logout", (req,res)=>{
    res.cookie('jwt','',{maxAge:1,sameSite:"none",secure:true, domain: "https://todayifeel.netlify.app"})
