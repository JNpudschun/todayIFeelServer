...
app.post("/user", async (req,res)=>{
    ...
    try{
        ...
        res.cookie('jwt',token,{maxAge:maxAge * 1000,httpOnly:true,sameSite:"none",secure:true,domain:"http://localhost:3000"})
...
app.get("/logout", (req,res)=>{
    res.cookie('jwt','',{maxAge:1,httpOnly:true,sameSite:"none",secure:true,domain:"http://localhost:3000"})
